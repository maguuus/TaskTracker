...
INSERT INTO "Projects" ("Id", "Name", "OwnerId", "CreatedAt") VALUES
    ('00000000-0000-0000-0000-000000000010', 'CI Test Project', '00000000-0000-0000-0000-000000000001', '2024-01-01 00:00:00+00');
...
INSERT INTO "TaskItems" ("Id", "Title", "Description", "Priority", "Urgency", "OrderIndex", "ColumnId", "CreatedAt", "UpdatedAt") VALUES
    ('00000000-0000-0000-0000-000000000030', 'CI Test Task', 'Seed task for integration tests', 'Medium', 'Normal', 0, '00000000-0000-0000-0000-000000000020', '2024-01-01 00:00:00+00', '2024-01-01 00:00:00+00');
